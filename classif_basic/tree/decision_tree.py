"""Adapted from the Kaggle tutorial to build decision trees from scratch
https://www.kaggle.com/code/fareselmenshawii/decision-tree-from-scratch#Model-Implementation
"""
import numpy as np
import pandas as pd
...
class DecisionTree():
    ...
    def fit(self, X, y):
        ...
        Args:
        X (ndarray or pd.DataFrame): The feature matrix.
        y (ndarray or pd.DataFrame): The target values.
        """
        if isinstance(X, pd.DataFrame) and isinstance(y, pd.Series):
            ...
            raise NotImplementedError("X and y must either be of pandas or numpy types")
